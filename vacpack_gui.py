...
class VacPackGUI(QWidget):
    ...
    def update_data(self, flow, mfc_pressure, pdr_pressure):
        ...
        self.pdr900_data.append(pdr_pressure)
        ...
        if len(self.x_data) > 60:
            ...
            self.pdr900_data = self.pdr900_data[-60:]
